...
<body>
	<header>
		<div class="wrap">
			<div class="logo">
				<a href="main.jsp"> <img src="../resources/stylesheets/images/logo.png"
	...
	<div id="login">
		...
		<div id="btn">
			<button class="btn-style"
				onclick="location.href='main-logined.jsp';">LOGIN</button>
		</div>
	...
	<div class="signUpMain">
		...
		<table>
			...
			<tr>
				<td>주민등록번호</td>
				<td><input type="text" name="주민등록번호" class="signUpText"
					placeholder="주민등록번호를 입력하세요"></td>
			</tr>
			<tr>
				<td>Tel</td>
				<td><input type="text" name="tel" class="signUpText"
					placeholder="전화번호를 입력하세요"></td>
			</tr>
			<tr>
				<td>addr</td>
				<td><input type="text" name="addr" class="signUpText"
					placeholder=" 주소를 입력하세요"></td>
			</tr>
			<tr>
				<td>e-mail addr</td>
				<td><input type="email" name="e-mail" class="signUpText"
			...
			<tr>
				<td class="usercheck" colspan="2"><input type="radio" name=" "
					value="userCheck" id="userGcheck"><label for="userGcheck">Guest</label>
					<input type="radio" name=" " value="userCheck" id="userHcheck"><label
					for="userHcheck">Host</label></td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: center;"><input
					class="signUpCon" type="submit" value="회원가입"></td>
			</tr>
		</table>
	</div>
			...
			<div class="footer-center">
				...
				<div>
					<img src="../resources/stylesheets/images/instagram.png"
						...
						src="../resources/stylesheets/images/facebook.png" class="footer-icon-img"
						alt="페이스북"> <img src="../stylesheets/images/youtube.png"
						class="footer-icon-img" alt="유튜브"> <img
						src="../resources/stylesheets/images/share.png" class="footer-icon-img"
						alt="공유">
