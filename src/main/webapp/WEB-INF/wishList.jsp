...
<head>
    ...
    <link rel="stylesheet" href="../stylesheets/css/wishlist.css">
        ...
        <div class="wishlist">
            ...
            <div class="wishlist-card-area">
                <div class="wishlist-card">
                    <div>
                        <img src="../stylesheets/images/ht2.png" alt=""  class="wish-card-img">
                    </div>
                    ...
                    <div class="wish-card-info">
                        <p>587,400원 / 1박</p>
                        <img src="../stylesheets/images/heart.png" alt="" style="width:20px; height:17px;">
                    </div>
                </div>
                <div class="wishlist-card">
                    <div>
                        <img src="../stylesheets/images/ht3.png" alt=""  class="wish-card-img">
                    </div>
                    <div class="wish-card-title">
                        <p><b>뉴욕, 힐튼 클럽 호텔</b></p>
                        <span>⭐⭐⭐⭐ 4.3</span>
                    ...
                    <div>
                        <img src="../stylesheets/images/ht11.png" alt=""  class="wish-card-img">
                    </div>
                    <div class="wish-card-title">
                        <p><b>서울, 롯데 호텔</b></p>
                        <span>⭐⭐⭐⭐ 4.3</span>
